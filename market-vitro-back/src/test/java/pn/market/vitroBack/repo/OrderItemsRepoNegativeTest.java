...
@SpringBootTest
public class OrderItemsRepoNegativeTest {
    ...
    void findByOrderId() {
        ...
        Assertions.assertNotEquals(Flux.empty(), orderItemsRepo.findByOrderId(1L));
    }
    ...
    void findByItemId() {
        Mockito.when(orderItemsRepo.findByItemId(1L))
                .thenReturn(orderItemsFlux);
        Assertions.assertNotEquals(Flux.empty(), orderItemsRepo.findByItemId(1L));
    }
    ...
    void countOfOrderAndItemId() {
        ...
        Assertions.assertNotEquals(Flux.empty(), orderItemsRepo.countOfOrderAndItemId(1L, 1L));
    }
