...
class ItemRepoTest {
    ...
    void findItemsByUserId() {
        ...
        Assertions.assertEquals(itemsFlux, itemRepo.findItemsByUserId(1L));
    }
    ...
    void findItemsByOrderId() {
        Mockito.when(itemRepo.findItemsByOrderId(1L))
                .thenReturn(itemsFlux);
        Assertions.assertEquals(itemsFlux, itemRepo.findItemsByOrderId(1L));
    }
    ...
    void findItemsByCartId() {
        Mockito.when(itemRepo.findItemsByCartId(1L))
                .thenReturn(itemsFlux);
        Assertions.assertEquals(itemsFlux, itemRepo.findItemsByCartId(1L));
    }
